...
# Linux (Debian-based) Tool Installation Script - ARM64/aarch64
# Tested on: Raspberry Pi OS 64-bit Lite (Raspberry Pi 5)
# Usage: chmod +x install_tools_arm64.sh && ./install_tools_arm64.sh
